...
async function main() {
  ...
  const experts = [
    ...
    // From bagdaddecor.com
    {
      ...
      bio: "Crafting exquisite custom furnishings, bespoke curtains, blinds, sofas, wallpaper, flooring, and decor to elevate your interiors. We offer a 7-Day Customer Support and 12-Month Warranty.",
      countryCode: "iq",
      featured: true,
      verified: true,
    },

    // From vestoreventure.com
    {
    ...
    // From palacerestaurantthailand.com
    {
  ...
  // ========================================
  // SERVICES & PORTFOLIO (for engineering expert)
  // ========================================
  ...
  console.log("✅ Created services and portfolio for engineering experts");

  console.log("✅ Database seeding completed successfully!");
}

// Helper function to determine expert categories
function getExpertCategories(expert: any): string[] {
  ...
  if (keywords.includes("metal") || keywords.includes("aluminum") || keywords.includes("fabricat") || keywords.includes("welding") || keywords.includes("cnc") || keywords.includes("machin")) {
