...
async function main() {
  ...
  // Add services for engineering experts
...
function getExpertCategories(expert: any): string[] {
  ...
  if (keywords.includes("metal") || keywords.includes("aluminum") || keywords.includes("fabrication") || keywords.includes("welding") || keywords.includes("cnc") || keywords.includes("machin")) {
