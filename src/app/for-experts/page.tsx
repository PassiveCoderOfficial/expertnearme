...
const FAQS = [
  ...
  },
  {
    ...
    a: 'The deal closes permanently on August 15 at midnight. Pro subscriptions open at $99/month or $499/year on launch day. No exceptions — no extensions.',
  },
  {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      ...
      <nav className="sticky top-0 z-40 bg-slate-950/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link
            ...
            className="bg-orange-500 hover:bg-orange-400 text-slate-900 font-semibold text-sm px-4 py-2 rounded-lg transition-colors"
          >
            Claim Spot
          </Link>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-16 text-center">
        <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }}>
          <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/30 rounded-full px-4 py-2 text-orange-300 text-sm font-medium mb-7">
            ...
            Pre-Launch · 453 of 500 Founding Expert spots remaining
          </div>
          ...
          <p className="text-sm text-slate-500">
            ...
            47 experts joined this week · 30-day money-back guarantee
          </p>
        </motion.div>
      </section>
      ...
      <section className="border-t border-white/5 bg-gradient-to-r from-orange-950/30 to-slate-900/60">
        <div className="max-w-3xl mx-auto px-6 py-20 text-center">
          ...
          <h2 className="text-4xl font-bold mb-4">
            Ready to join 47+ founding experts?
          </h2>
      ...
      <footer className="border-t border-white/5 bg-slate-950/50">
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          <div>
            <span className="text-orange-400 font-bold mr-2">ExpertNear.Me</span>
